...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" href="http://192.168.0.158:9900/static/assets/i/favicon.png">
  <meta name="msapplication-TileImage" content="http://192.168.0.158:9900/static/assets/i/favicon.png">
...
<header class="am-g am-g-fixed blog-fixed blog-text-center blog-header">
    <div class="am-u-sm-8 am-u-sm-centered">
        <img width="200" src="http://192.168.0.158:9900/static/assets/i/logo.jpg"/>
...
<button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only blog-button" data-am-collapse="{target: '#blog-collapse'}" ><span class="am-sr-only">导航切换</span> <span class="am-icon-bars"></span></button>
  ...
  <div class="am-collapse am-topbar-collapse" id="blog-collapse">
    ...
    <#if tokenVertify?exists>
          <li class="am-active">
              <a href="/admin/user/logout" class="layout-user-downmenu-link" data-mtype="wmz_public_grzx_myorder">注销</a>
          </li>
    <#else>
          <li class="am-active">
              <a href="/admin/user/logup" class="layout-user-downmenu-link">立即登录</a>
          </li>
    </#if>
