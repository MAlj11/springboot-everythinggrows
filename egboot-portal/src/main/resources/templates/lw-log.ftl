...
<header>
  <div class="log-re">
    <button type="button" class="am-btn am-btn-default am-radius log-button" onclick="window.location.href='/registerPage.html'">注册</button>
  </div> 
</header>
  ...
  <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
    ...
    <form class="am-form" id="log-form" action="/login.html" method="post">
      <div class="am-input-group am-radius am-animation-slide-left">       
        <input type="email" id="doc-vld-email-2-1" name="loEmail" class="am-radius" data-validation-message="请输入正确邮箱地址" placeholder="邮箱" required/>
