...
<nav id="menu">
	<ul class="links">
		...
		<li><a href="/loginPage.html">登陆</a></li>
	</ul>
</nav>
...
<section id="1" class="wrapper post bg-img" data-bg="sheying.jpg">
	<div class="inner">
		<article class="box">
			...
			<footer>
				<a href="/type/Photography.html" class="button alt">更多</a>
			</footer>
		</article>
	</div>
...
<section id="2" class="wrapper post bg-img" data-bg="hulianwang.jpg">
	<div class="inner">
		<article class="box">
			...
			<footer>
				<a href="/type/Internet.html" class="button alt">更多</a>
			</footer>
		</article>
	</div>
...
<section id="3" class="wrapper post bg-img" data-bg="yingyin.jpg">
	<div class="inner">
		<article class="box">
			...
			<footer>
				<a href="/type/media.html" class="button alt">更多</a>
			</footer>
		</article>
	</div>
...
<section id="4" class="wrapper post bg-img" data-bg="ganwu.jpg">
	<div class="inner">
		<article class="box">
			...
			<footer>
				<a href="/type/feeling.html" class="button alt">更多</a>
			</footer>
		</article>
	</div>
    <a href="#footer" class="more">更多</a>
</section>
...
<footer id="footer">
	<div class="inner">
		...
		<form action="/index.html" method="post">
            ...
            -->
            <ul class="actions">
                <li><input value="开始<枝丫>旅程" class="button alt" type="submit"></li>
            </ul>
		</form>
