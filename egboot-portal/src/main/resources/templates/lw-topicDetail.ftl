...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="http://192.168.0.158:8080/static/assets/i/app-icon72x72@2x.png">
    <meta name="msapplication-TileImage" content="http://192.168.0.158:8080/static/assets/i/app-icon72x72@2x.png">
...
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        ...
        <#if tokenVertify>
          <li class="am-active">
              <a href="/topic/detail/write/${topicTidd}" class="layout-user-downmenu-link"
                 data-mtype="wmz_public_grzx_myorder">添加回复</a>
          </li>
        <#else>
          <li class="am-active">
